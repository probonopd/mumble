...
if [ "${TRAVIS_OS_NAME}" == "linux" ]; then
	...
	if [ "${MUMBLE_QT}" == "qt4" ] && [ "${MUMBLE_HOST}" == "x86_64-linux-gnu" ]; then
		...
		sudo apt-get -qq update
		sudo apt-get build-dep -qq mumble
		sudo apt-get install libqt5sql5 libqt5sql5-sqlite qt5-default qttools5-dev qttools5-dev-tools qtbase5-dev qtbase5-dev-tools qttranslations5-l10n libqt5svg5-dev libgtk2.0-dev libjack-jackd2-dev
